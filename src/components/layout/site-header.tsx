      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-3 px-4 py-4 sm:px-6 lg:px-8">
        <Link href="/" className="flex items-center gap-3">
          <Image
            ...
            height={500}
            priority
            className="h-12 w-auto rounded-none ring-1 ring-[#efc4ce] sm:h-14"
          />
        ...
        <nav className="hidden items-center gap-2 rounded-none bg-white/80 p-2 shadow-soft ring-1 ring-[#f1d9dd] md:flex">
          {siteNavLinks.map((link) => (
            <Link
              key={link.href}
              href={link.href}
              className={cn(
                "rounded-none px-4 py-2 text-sm transition hover:text-berry-700",
                pathname === link.href
        ...
        <div className="hidden items-center gap-4 text-sm sm:flex">
          ...
          <Link
            href="/cart"
            className="relative flex h-10 w-10 items-center justify-center rounded-none bg-ink text-white transition hover:bg-[#2b1b22] hover:text-[#ffd5e1] shadow-soft"
        ...
        <div className="flex items-center gap-2 md:hidden">
          <Link
            href="/cart"
            className="relative flex h-11 w-11 items-center justify-center rounded-none bg-white text-ink shadow-soft ring-1 ring-[#f1d9dd] transition hover:text-berry-700"
            aria-label="Shopping Cart"
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" className="h-5 w-5">
              <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 10.5V6a3.75 3.75 0 1 0-7.5 0v4.5m11.356-1.993 1.263 12c.07.665-.45 1.243-1.119 1.243H4.25a1.125 1.125 0 0 1-1.12-1.243l1.264-12A1.125 1.125 0 0 1 5.513 7.5h12.974c.576 0 1.059.435 1.119 1.007ZM8.625 10.5a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm7.5 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Z" />
          ...
          <button
            ...
            className="inline-flex h-11 w-11 items-center justify-center rounded-none bg-ink text-white shadow-soft transition hover:bg-berry-700"
          ...
          <nav className="mx-auto grid max-w-7xl gap-2">
            ...
            <div className="mt-2 grid grid-cols-2 gap-2">
              <Link
                ...
                className="rounded-none bg-white px-4 py-3 text-center text-sm font-semibold text-black/70 ring-1 ring-black/5"
              >
                {isReady && isAuthenticated && customer?.name ? customer.name.split(" ")[0] : "Sign In"}
              </Link>
              <Link
                href="/cart"
                className="flex items-center justify-center gap-2 rounded-none bg-ink px-4 py-3 text-center text-sm font-semibold text-white"
              >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" className="h-5 w-5">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 10.5V6a3.75 3.75 0 1 0-7.5 0v4.5m11.356-1.993 1.263 12c.07.665-.45 1.243-1.119 1.243H4.25a1.125 1.125 0 0 1-1.12-1.243l1.264-12A1.125 1.125 0 0 1 5.513 7.5h12.974c.576 0 1.059.435 1.119 1.007ZM8.625 10.5a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm7.5 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Z" />
                </svg>
                Cart
                {isReady && cartItemCount > 0 && (
                  <span className="ml-1 rounded-none bg-berry-600 px-2 py-0.5 text-[10px] font-bold text-white">
                    {cartItemCount}
                  </span>
                )}
              </Link>
